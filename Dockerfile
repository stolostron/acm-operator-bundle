...
LABEL com.redhat.delivery.operator.bundle="true" \
      ...
      operators.operatorframework.io.bundle.channels.v1="stable-5.1" \
      operators.operatorframework.io.bundle.channel.default.v1="stable-5.1" \
      com.redhat.openshift.versions="v5.0-v5.2"
...
LABEL com.redhat.component="acm-operator-bundle-container" \
      ...
      konflux.additional-tags="v5.1.0-65,snapshot-release-acm-51-20260829-233731-000-m0" \
      vendor="Red Hat, Inc." \
