...
LABEL com.redhat.delivery.operator.bundle="true" \
      ...
      operators.operatorframework.io.bundle.channels.v1="stable-5.0" \
      operators.operatorframework.io.bundle.channel.default.v1="stable-5.0" \
      com.redhat.openshift.versions="v5.0-v5.1"
...
LABEL com.redhat.component="acm-operator-bundle-container" \
      ...
      konflux.additional-tags="v5.0.0-28,snapshot-release-acm-50-20260424-104554-000-9j" \
      vendor="Red Hat, Inc." \
