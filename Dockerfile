...
LABEL com.redhat.delivery.operator.bundle="true" \
      ...
      operators.operatorframework.io.bundle.channels.v1="release-2.11" \
      operators.operatorframework.io.bundle.channel.default.v1="release-2.11" \
...
LABEL com.redhat.component="acm-operator-bundle-container" \
      ...
      konflux.additional-tags="v2.11.0-10,snapshot-release-acm-211-dq76b" \
      vendor="Red Hat, Inc." \
